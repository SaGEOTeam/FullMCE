...
from PyQt4.QtGui import QAction, QIcon, QHeaderView, QMessageBox, QWidget, QFileDialog
...
class full_mce:
    ...
    def __init__(self, iface):
        ...
        # Append QGIS Installation Dir to sys.path
        sys.path.append('%OSGEO4W_ROOT%\\bin')
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/full_mce/icon.png'
        self.add_action(
            icon_path,
